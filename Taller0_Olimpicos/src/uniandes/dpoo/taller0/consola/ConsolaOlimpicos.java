...
public class ConsolaOlimpicos
{
	...
	/**
	 * Ejecuta la aplicacion: le muestra el menú al usuario y la pide que ingrese
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais al cual representa un atleta.");
	...
	/**
	 * Muestra cuales han sido los atletas (o el atleta) que mas medallas ha ganado.
	 */
	private void ejecutarAtletaEstrella()
	{
		...
		for (Map.Entry<String, Integer> entry : estrellas.entrySet())
		{
			...
			int medallas = entry.getValue();
			System.out.println(nombre + " gano " + medallas + " medallas");
		}

	}

	/**
	 * Le pide al usuario una cantidad minima de medallas y luego le muestra la
	 * informacion de los atletas que han ganado mas de esa cantidad de medallas.
	 */
	private void ejecutarAtletasConMasMedallasQue()
	{
		System.out.println("\n" + "Atletas con minimo de medallas" + "\n");

		try
		{
			int cantidadMinima = Integer.parseInt(input("Ingrese la cantidad minima de medallas"));
			Map<String, Integer> atletas = calculadora.atletasConMasMedallas(cantidadMinima);
			System.out.println(
					"Hay " + atletas.size() + " atletas que han ganado mas de " + cantidadMinima + " medallas.");
		...
		{
			System.out.println("El número ingresado no es valido. Por favor escriba un número entero.");
		}
	}
	...
	/**
	 * Consulta el pais (o los paises) con mas medallistas
	 */
	private void ejecutarPaisConMasMedallistas()
	{
		...
		if (paises.size() > 1)
		{
			System.out.println("Hay " + paises.size() + " paises empatados en el primer lugar.");
		}
	...
	/**
	 * Le pide al usuario el nombre de un pais y luego le muestra la informacion de
	 * todos los atletas de ese pais.
	 */
	private void ejecutarAtletasPorPais()
	{
		...
		if (atletas == null)
		{
			System.out.println("No existe un pais con ese nombre");
		}
		else
		{
	...
	/**
	 * Le pide al usuario un rango de anios y el nombre de un atleta. A continuacion
	...
	private void ejecutarMedallasEnRango()
	{
		...
		try
		{
			int anio_inicial = Integer.parseInt(input("Ingrese el anio inicial para el rango"));
			int anio_final = Integer.parseInt(input("Ingrese el anio final para el rango"));
			...
			if (medallas == null)
			{
				System.out.println("No se encontro un atleta llamado " + nombre_atleta);
			}
			else
			{
				System.out.println("El atleta " + nombre_atleta + " ha ganado " + medallas.size() + " medallas.");
	...
	{
		System.out.println("\n" + "Pais representado por un atleta" + "\n");

		String nombre_atleta = input("Ingrese el nombre del atleta que le interesa");
		
		Object paisDelatleta = calculadora.paisdeatleta(nombre_atleta);
		
		System.out.println("El pais que representa " + nombre_atleta + "es: " + paisDelatleta);
	}
	/**
	 * Ejecuta la opcion para consultar los atletas de un anio.
	 */
	private void ejecutarAtletasPorAnio()
	{
		System.out.println("\n" + "Medallas de un atleta en un periodo" + "\n");

		int anio = Integer.parseInt(input("Ingrese el anio de su interes"));
	...
	private void ejecutarCargarAtletas()
	{
		...
		try
		{
			...
			System.out.println("Los deportes para los que se tiene informacion son:");
